...
class S3BucketConnector():
    ...
    def read_csv_to_df(self, key: str, encoding: str = 'utf-8', sep: str = ','):
        """
        Reading a csv file from the S3 bucket and returing a dataframe
        ...
        returns:
        data_fram: Pandas DataFrame containing the data of the csv file
        """
    ...
    def write_df_to_s3(self, data_frame: pd.DataFrame, key: str, file_format: str):
        ...
        :data_frame: Pandas DataFrame taht should be written
        :key: target key of the saved file
        :file format: format of the saved file
        """
        if data_frame.empty:
