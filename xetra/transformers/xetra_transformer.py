...
class XetraSourceConfig(NamedTuple):
    ...
    src_col_start_price: column name for starting pricei n source
...
class XetraTargetConfig(NamedTuple):
    ...
    trg_col_on_price: column name for opening price in target
    ...
    trg_col_ch_prev_clos: column name for change to previous day's closing price int arget
